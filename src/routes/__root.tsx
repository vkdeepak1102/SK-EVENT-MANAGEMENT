...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Crafting unforgettable luxury experiences. Royal weddings, celebrity & yacht events across India." },
      { name: "author", content: "SK Events & Management" },
